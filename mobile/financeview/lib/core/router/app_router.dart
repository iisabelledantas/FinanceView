...
import '../../features/dashboard/presentation/income_transactions_screen.dart';
    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
              path: '/income',
              builder: (_, __) => const IncomeTransactionsScreen()),
          GoRoute(
              path: '/transactions',
              builder: (_, __) => const TransactionsScreen()),
          GoRoute(path: '/import', builder: (_, __) => const ImportScreen()),
          GoRoute(
              path: '/analysis', builder: (_, __) => const AnalysisScreen()),
